...
/*В файле Main будем демонстрировать данную программу. !!! Аня, прочитай все комменты очень внимательно !!!*/

/*Я тебе на работе скажу, какой вопрос ты должна задать Касимову по поводу этой проги*/
